<%@ Page Title="Home Page" Language="C#" MasterPageFile="/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SlienGames.Web._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
              ...
              <div id="slider">
                ...
                <div class="holder">
                  ...
                  <div class="content">
                    ...
                    <li class="fragment">
                      <div class="image">
                      <img src="/Content/style/images/img10.jpg" alt="" /> 
                  </div>
                  <div class="cnt">
                    <div class="cl">&nbsp;</div>
                    <div class="side-a">
                  ...
                  <li class="fragment">
                    <div class="image"> <img src="/Content/style/images/img10.jpg" alt="" /> </div>
                    <div class="cnt">
                      <div class="cl">&nbsp;</div>
                      <div class="side-a">
                        <h4>StarCraft II</h4>
      ...
      <div class="block">
        <div class="block-bot">
          ...
          <div class="col-articles articles">
            <div class="cl">&nbsp;</div>
            <div class="article">
              <div class="image"> <a href="#"><img src="/Content/style/images/img4.jpg" alt="" /></a> </div>
              <h4><a href="#">F.E.A.R.2</a></h4>
              <p class="console"><strong>PSP3</strong></p>
            </div>
            <div class="article">
              <div class="image"> <a href="#"><img src="/Content/style/images/img5.jpg" alt="" /></a> </div>
              <h4><a href="#">FALLOUT 3</a></h4>
              <p class="console"><strong>PC</strong></p>
            </div>
            <div class="article">
              <div class="image"> <a href="#"><img src="/Content/style/images/img6.jpg" alt="" /></a> </div>
      ...
      <div class="block">
        <div class="block-bot">
          ...
          <div class="row-articles articles">
            ...
            <div class="article">
              <div class="cl">&nbsp;</div>
              <div class="image"> <a href="#"><img src="/Content/style/images/img7.jpg" alt="" /></a> </div>
              <div class="cnt">
                <h4><a href="#">F.E.A.R.2</a></h4>
            ...
            <div class="article">
              <div class="cl">&nbsp;</div>
              <div class="image"> <a href="#"><img src="/Content/style/images/img8.jpg" alt="" /></a> </div>
              <div class="cnt">
                <h4><a href="#">FALLOUT 3</a></h4>
            ...
            <div class="article last-article">
              <div class="cl">&nbsp;</div>
              <div class="image"> <a href="#"><img src="/Content/style/images/img9.jpg" alt="" /></a> </div>
              <div class="cnt">
                <h4><a href="#">STARCRAF II</a></h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum molestie urna, id scelerisque leo sodales sit amet. Curabitur volutpat lorem euismod nunc tincidunt condimentum. Suspendisse gravida elementum mauris, in vulputate justo ultrices sit amet. Maecenas ultricies elit in mi sagittis fringilla.</p>
              </div>
      ...
      <div class="block">
        <div class="block-bot">
          ...
          <div class="image-articles articles">
            ...
            <div class="article">
              <div class="cl">&nbsp;</div>
              <div class="image"> <a href="#"><img src="/Content/style/images/img1.gif" alt="" /></a> </div>
              <div class="cnt">
                <h4><a href="#">TMNT</a></h4>
            ...
            <div class="article">
              <div class="cl">&nbsp;</div>
              <div class="image"> <a href="#"><img src="/Content/style/images/img2.gif" alt="" /></a> </div>
              <div class="cnt">
                <h4><a href="#">F.E.A.R.2</a></h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum molestie </p>
              </div>
            ...
            <div class="article">
              <div class="cl">&nbsp;</div>
              <div class="image"> <a href="#"><img src="/Content/style/images/img3.gif" alt="" /></a> </div>
              <div class="cnt">
    ...
    <script src='<%= ResolveUrl("/Scripts/fns.js") %>'></script>    
